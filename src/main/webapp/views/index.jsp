        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               <a class="nav-link" href="/UserRegistrationPage">User Registration</a>
               <a class="nav-link" href="/Ledgerpage">Ledger Detial</a>
               <a class="nav-link" href="/AccountRegistrationPage">Account Registration</a>
               <a class="nav-link" href="/accountDetials">Account Detials</a>
               <a class="nav-link" href="/userlistpage">user list </a>
               <a class="nav-link" href="/Transctiondetialpage">Transction detial </a>
               <a class="nav-link" href="/tractionList"> Transction  </a>
